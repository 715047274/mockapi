import { EntryIssueEmployeeIssueType } from '@models/entry-issue/EntryIssueTypes';
import {
    EntryIssueEmployeeActionTypeEnum,
    EntryIssueEmployeeIssueTypeEnum,
} from '@models/enums/EntryIssueEnum';
import { PayRunIssuesSummaryType } from '@models/pay-run';
import {
    chaoticInt,
    chaoticObjects,
    chaoticSelect,
} from '@mocks/chaoticGenerationUtils';
import { mockDataOptions } from '@mocks/api/data-entry/adjustment/adjustment-provider-options';
import { PayrollValidationMessage } from '@models/common/PayrollValidationMessage';

export const getPayRunIssuesSummary = (): PayRunIssuesSummaryType[] => {
    return [
        {
...
export const getEmployeeIssues = (
    issueCount?: number
): EntryIssueEmployeeIssueType[] => {
    const employeeIssues: EntryIssueEmployeeIssueType[] = [
        {
            employeeId: 1917,
...
export const getEntryIssues = (
    ...
    const issues: PayrollValidationMessage[] = chaoticObjects(
        issueOptions,
