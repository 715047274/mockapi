...
// provide null value to satisfy graph ql mocks
const earningCodeTemplate: CodeType = {
...
export const AllEarningCodes: Array<CodeType> = [
    {
        ...earningCodeTemplate,
        codeId: 1,
        shortName: 'Holiday',
...
export const EarningCodes: Array<CodeType> = AllEarningCodes.filter(
    (x) => !x.isInternal
);
