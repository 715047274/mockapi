...
export const getMockUserRole = (): IUserRole => mockUserRoles[1];

export const mockUserRoles: IUserRole[] = [
    {
        RoleId: 1,
        ShortName: 'Client Administrator',
        XRefCode: 'CLIENT ADMINISTRATOR',
        IsSystemRole: false,
        IsDefault: true,
        IsAutoSelected: true,
...
export const mockRoleAccessAuthorizations: GetRoleAccessAuthorizationsType = {
