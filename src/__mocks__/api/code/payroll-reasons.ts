import {
    PayrollReasonType,
    GetPayrollReasonsResponseType,
} from '@models/check/PayrollReasonTypes';
import { PayrollReasonConstants } from '@models/constants/PayrollReasonConstants';
import { PayRunReasonScope } from '@models/enums/PayrollReasonEnum';

export function getPayrollReasons(): GetPayrollReasonsResponseType {
    const payrollReasons: Array<PayrollReasonType> = [
        {
            reasonId: 1,
